...
- [Bối cảnh: Bug "vô hình" — field đã ghi nhưng thread khác đọc thấy 0](#1-bối-cảnh-bug-vô-hình--field-đã-ghi-nhưng-thread-khác-đọc-thấy-0)
...
## 1. Bối cảnh: Bug "vô hình" — field đã ghi nhưng thread khác đọc thấy 0
