...
- [Bối cảnh: 10.000 request/s nhưng chỉ 8 thread xử lý](#1-bối-cảnh-10000-requests-nhưng-chỉ-8-thread-xử-lý)
...
## 1. Bối cảnh: 10.000 request/s nhưng chỉ 8 thread xử lý
